...
function convertToPro(proLang)
{
    ...
    switch(lang)
     ...
     document.getElementById('code_run').innerHTML="<pre><code><textarea style='width:100%;height:1000px' readonly>"+code+"</textarea></pre></code>";     
        alert(code);
...
function print_output()
{
    ...
    var op= document.getElementById("code_run");
    windows.location="/print/index.php?code_output="+op;
}