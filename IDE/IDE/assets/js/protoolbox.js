...
workspacePlayground.updateToolbox("<category name='%{BKY_CATFUNCTIONS}' colour='%{BKY_PROCEDURES_HUE}' custom='PROCEDURE'><block type='procedures_defnoreturn'></block><block type='procedures_defreturn'></block> </category>");
